...
var testdata = require('../../test/data'); // TODO only load based on flag
        ...
        return(
            <div className="builder container-fluid">
                <div className="row">
                    ...
                    <PreviewPanel className="col-md-6 preview-panel" sections={this.props.sections} data={this.state._data}/>
                </div>
            </div>
        );
    },

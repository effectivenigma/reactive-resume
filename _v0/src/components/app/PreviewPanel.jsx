...
var Columnd = require('../../../themes/components/Columnd');
var Columnd2 = require('../../../themes/components/Columnd2');
    ...
    render: function(){
        return(
            <Panel {...this.props}>
                ...
                <Columnd2 data={this.props.data} sections={this.props.sections}/>
            </Panel>
        )
    }
});
